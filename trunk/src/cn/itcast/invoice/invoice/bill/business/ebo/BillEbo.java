...
public class BillEbo implements BillEbi{
	...
	static {
		...
		theme.setExtraLargeFont(new Font("ÃƒÂ¥Ã‚Â®Ã¢â‚¬Â¹ÃƒÂ¤Ã‚Â½Ã¢â‚¬Å“", Font.PLAIN, 20));
		theme.setLargeFont(new Font("ÃƒÂ¥Ã‚Â®Ã¢â‚¬Â¹ÃƒÂ¤Ã‚Â½Ã¢â‚¬Å“", Font.PLAIN, 14));
		theme.setRegularFont(new Font("ÃƒÂ¥Ã‚Â®Ã¢â‚¬Â¹ÃƒÂ¤Ã‚Â½Ã¢â‚¬Å“", Font.PLAIN, 12));
		theme.setSmallFont(new Font("ÃƒÂ¥Ã‚Â®Ã¢â‚¬Â¹ÃƒÂ¤Ã‚Â½Ã¢â‚¬Å“", Font.PLAIN, 10));
